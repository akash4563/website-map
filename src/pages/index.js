...
import { Override, Menu, Section, StackItem, Stack, Formspree, SocialMedia, GoogleMap } from "@quarkly/components";
			...
			<Stack>
				...
				<StackItem width="50%" md-width="100%">
					...
					>
						...
						<Formspree errorMessage="Something went wrong" completeText="Success" endpoint="name">
